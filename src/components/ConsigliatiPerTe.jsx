...
const ConsigliatiPerTe = () => {
  return (
    <div className="bg-white border rounded p-3">
      ...
      <Card className="bg-white border-0 border-bottom">
        <Card.Body className="pb-0">
          <div className="d-flex align-items-start mb-4">
            ...
            <div className="d-flex justify-content-between flex-grow-1">
              <div>
                <Card.Title className="mb-1">Nome Utente</Card.Title>
                <Card.Text className="text-muted small mb-0">Italiano</Card.Text>
              </div>
              <div className="ms-3 d-flex align-items-center">
                <Button variant="light" size="sm" className="rounded-pill border-dark small">
